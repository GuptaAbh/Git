		...
		<table>
			...
			<tbody>
				<tr ng-repeat="college in CollegeList">
					<td><input ng-readonly="true" type="text" value="{{college.collegeId}}"/></td>
					<td><input ng-readonly="update" value="{{college.collegeName}}"/></td>
					<td ng-click="updateclick()" ng-show="updatebutton"><input type="button" value="Update Record"></td>
					<td ng-show="savebutton({{college.collegeId}})"><input type="button" value="Save Record"></td>
				</tr>
			</tbody>
