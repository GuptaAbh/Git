...
<body ng-controller="admincontroller">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="logoutadmin">Logout</a> <a href="#"
			class="navbar-brand" ng-click="searchtweets()">Search Tweets</a> <a
			href="#" class="navbar-brand" ng-click="showaddCollegeform()">Add
			College</a> <a href="#" class="navbar-brand" ng-click="viewCollege()">View
			College</a>
	...
	<input type="text" ng-model="searchTweets" placeholder="Seasrch tweets">
	<table class="table">
...
<script>
	...
	app.controller("admincontroller", function($scope, $http) {
		...
		$scope.searchtweets = function() {
			$http.get('loadtweets', {
				params : {
					"searchTweets" : $scope.searchTweets
				}
